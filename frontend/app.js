...
async function carregarMapeamentoPassivos() {
  const [motivosMensal, motivosResumo, evolucaoMensal, topRecorrentes, topImpacto, fluxoInventarioMensal] = await Promise.all([
  ...
  // Resumo executivo (12/08/2026): substitui os 9 KPI cards antigos (confirmado
  // com o Maurício) por só Passivos + Resultado de Inventário Acumulado,
  // filtráveis, com narração em voz - mas os 2 gráficos acima (Evolução Mensal e
  // Fluxo de Inventário) continuam os mesmos de sempre, não foram tocados.
